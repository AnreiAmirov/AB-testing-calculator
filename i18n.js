...
const T = {
  en: {
    ...
    cases_sub:'Five real-world stories, each using a different metric. Every one follows the same arc — problem, plan, run, analyse, decide — and shows how to size a test efficiently with a holdout instead of exposing everyone.',
  ...
  ru: {
    ...
    cases_sub:'Пять реальных историй, каждая на своей метрике. Все следуют одной схеме — задача, план, запуск, анализ, решение — и показывают, как экономно задать размер теста через холдаут, не подвергая изменению всех.',
