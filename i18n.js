...
const T = {
  en: {
    ...
    py_sub:'Language fundamentals, dataset design and six real business cases. Every chart on this page was produced by running the code shown next to it.',
    py_toc_h:'On this page',
    py_back_ab:'← A/B Testing Calculator', py_back_causal:'Causal Inference',
    ...
    py_nav_1:'Python fundamentals in practice',
    py_nav_2:'How a dataset is built',
    py_nav_3:'Writing code properly',
    py_nav_4:'pandas: select & group',
    py_nav_5:'Checking and cleaning data',
    py_nav_6:'Case: funnel',
    py_nav_7:'Case: ARPU vs median',
    py_nav_8:'Case: cohorts',
    py_nav_9:'Case: A/B test',
    py_nav_10:'Case: RFM segments',
    py_nav_11:'Case: anomalies',
    py_nav_12:'Advanced visualisation',
    py_nav_13:'Rules for a good chart',
    py_nav_14:'Common mistakes',
    nav_home:'Home',
  ...
  ru: {
    ...
    py_sub:'Основы языка, устройство датасетов и шесть реальных бизнес-кейсов. Каждый график на этой странице получен реальным запуском кода, показанного рядом.',
    py_toc_h:'Содержание',
    py_back_ab:'← Калькулятор A/B-тестов', py_back_causal:'Причинно-следственный вывод',
    ...
    py_nav_1:'Основы Python на практике',
    py_nav_2:'Как устроен датасет',
    py_nav_3:'Как писать код правильно',
    py_nav_4:'pandas: выбор и группировка',
    py_nav_5:'Проверка и чистка данных',
    py_nav_6:'Кейс: воронка',
    py_nav_7:'Кейс: ARPU и медиана',
    py_nav_8:'Кейс: когорты',
    py_nav_9:'Кейс: A/B-тест',
    py_nav_10:'Кейс: RFM-сегменты',
    py_nav_11:'Кейс: аномалии',
    py_nav_12:'Продвинутая визуализация',
    py_nav_13:'Правила хорошего графика',
    py_nav_14:'Частые ошибки',
    nav_home:'Главная',
    home_brand:'Data for Everyone',
